...
Ezeknek a módszereknek a szerepe nem csak a támadás, hanem felhasználhatóak a tanítás során a modellek robosztusságá tételére is. 
Ez úgy történik, hogy az eredeti és az adversarial képből egy kombinált veszteségfüggvényt állítunk elő az alábbi módon: 
(J~ = alpha*J(x,y) + (1-alpha)*J(x+eta,y)),
itt az lambda paraméter a súlyozás arányát jelöli. 
A formula egyetlen adversarial képeet integrál a a költségfüggvénybe, majd az így kapottat használja fel újra rekurzívan. 
A ódszer eredményességét kísérletekkel igazolták, FGSM-alapú ellenfél-alapú példákon mért hibaarány 89,4%-ról 17,9%-ra csökkent. 
