...
% TODO: az adversarial példák azon tulajdonsága, hogy egy modellre generált perturbáció gyakran más,
...
Ennek lényege, hogy a tiszta $x$ kép mellett a hozzá tartozó $x_{\mathrm{adv}}$ adversarial képet is bevonjuk a veszteségfüggvénybe, és a modell 
...
\]
Az új veszteségfüggvény tehát a tiszta és az adversarial minta hibáját egyaránt bünteti, méghozzá úgy, hogy $x_{\mathrm{adv}}$-ot minden tanítási lépésben a 
modell aktuális $\theta$ paramétereivel újraszámolják. 
Így tehát a modell a tanítás során folyamatosan fejlődik, és az aktuális állapota által generált adversarial példákon tanul tovább dinamikusan, nem pedig 
egy előre legyártott, statikus adversarial halmazon. 
Kísérleteik megmutatták, hogy ez egy hatékony módszer: az FGSM-alapú adversarial példákon mért hibaarány 89,4\%-ról 17,9\%-ra csökkent. 

Madry és társai megmutatták, hogy PGD-vel is alkalmazható az adversarial training, és erősebb védekezést eredményez~\cite{madry2018towards}. 
Itt azonban a tiszta és adversarial veszteséget kombináló FGSM-formulával ellentétben nincs szó keverésről: a tanítás során a tiszta $x$ kép 
helyett kizárólag a hozzá tartozó, PGD-vel előállított $x_{\mathrm{adv}}$-on számolják a veszteséget, tehát a modell csak az adversarial bemeneteken tanul. 
...
% (ReLU, maxout stb. miatt) lokálisan lineárisan, és ez hogyan magyarázza az adversarial példák
