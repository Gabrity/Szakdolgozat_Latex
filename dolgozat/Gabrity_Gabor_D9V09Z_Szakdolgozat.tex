...
bővíthető, jelenleg kettő van integrálva (ResNet50, MobileNetV2).
Beállíthatóak a futás paraméterei:
\begin{itemize}
...
A vizuális megjelenítés céljai a következők:
\begin{itemize}
  \item a fájlrendszerről kiválasztott képet legördülő menüből kiválasztott modellel klasszifikálni tudjuk;
  ...
  \item a védekezési modulban hozzáadhatunk a képhez valamilyen filtert, amely csökkentheti a támadás hatékonyságát.
\end{itemize}
