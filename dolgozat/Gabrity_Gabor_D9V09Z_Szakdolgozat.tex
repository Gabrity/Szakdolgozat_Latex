...
viszont az $y_{\mathrm{adv}} = f(x_{\mathrm{adv}})$ az $y$ osztálytól vagy eltér, vagy a klasszifikáció elbizonytalanodik.
...
A támadás feltétele, hogy az $f$ modell gradienseihez, azaz a súlyokhoz teljes hozzáférésünk legyen.
...
A már korábban említett $f$ osztályozó modellünk pontos jelölése $f_\theta$, ahol $\theta$ a modellhez tartozó súlyokat jelöli, melyeket a 
tanulás során szerez. 
...
A modell által meghatározott legvalószínűbb osztály indexét a legnagyobb valószínűségű komponens
kiválasztásával kapjuk:
\[
  \hat{y} = \arg\max_{i} p_i = \arg\max_{i} z_i.
\]
Ezzel pontosítható a 4.1 alfejezetben bevezetett $y$ jelölés: ismert címke hiányában $y := \hat{y}$.
